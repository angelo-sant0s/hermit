...
const Input: React.FC<InputProps> = ({id, label, type, disabled, formatPrice, register, required, errors}) => {
  return (
    <div className="w-full relative">
      ...
      <input 
        type={type} id={id} disabled={disabled}
        ...
        className={`
          ...
          ${errors[id] ? "border-teal-500 focus:border-teal-500" : "border-neutral-300 focus:border-black"}
        `}
      />
        <label className={`
