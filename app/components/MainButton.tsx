...
const MainButton: React.FC<MainButtonProps> = ({label , onClick, disabled, outline, small, icon: Icon}) => {
    ...
    return(
        <button 
            ...
            ${outline ? "bg-white text-black border-black" : "bg-teal-500 border-teal-500 text-white"}
